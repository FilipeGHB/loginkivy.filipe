...
class TelaLogin(BoxLayout):
    def __init__(self, **kwargs):
        ...
        self.login_button = Button(text='Entrar', size_hint=(None, None), size=(450, 50),
                                   background_color=(100, 100, 100, 100))
        self.login_button.bind(on_press=self.login)
        self.signup_button = Button(text='Cadastre-se', size_hint=(None, None), size=(450, 50),
                                    background_color=(100, 100, 100, 100))
...
class TelaCadastro(BoxLayout):
    def __init__(self, **kwargs):
        ...
        self.buttons_layout = BoxLayout(padding=[0, 10], spacing=10)
        self.signup_button = Button(text='Cadastrar', color=(0, 0, 0.1, 1), size_hint=(None, None), size=(450, 50),
                                    background_color=(100, 100, 100, 100))
